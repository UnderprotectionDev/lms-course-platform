  ...
  return (
    <Link
      ...
      className={buttonVariants({
        ...
        className: cn(
          "w-full p-3 h-auto justify-start transition-all",
          completed &&
          ...
          isActive &&
            !completed &&
            "bg-primary/10 dark:bg-primary/20 border-primary/50 hover:bg-primary/20 dark:hover:bg-primary/30text-primary-foreground"
        ),
      })}
    >
